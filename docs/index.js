 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */;let gt=class extends Event{constructor(t,e,s){super("context-request",{bubbles:!0,composed:!0}),this.context=t,this.callback=e,this.subscribe=s??!1}};
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _t=1,$t=2,At=t=>(...e)=>({_$litDirective$:t,values:e});let wt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{D:xt}=nt,Ct=()=>document.createComment(""),St=(t,e,s)=>{const i=t._$AA.parentNode,r=void 0===e?t._$AB:e._$AA;if(void 0===s){const e=i.insertBefore(Ct(),r),o=i.insertBefore(Ct(),r);s=new xt(e,o,t,t.options)}else{const e=s._$AB.nextSibling,o=s._$AM,n=o!==t;if(n){let e;s._$AQ?.(t),s._$AM=t,void 0!==s._$AP&&(e=t._$AU)!==o._$AU&&s._$AP(e)}if(e!==r||n){let t=s._$AA;for(;t!==e;){const e=t.nextSibling;i.insertBefore(t,r),t=e}}}return s},Et=(t,e,s=t)=>(t._$AI(e,s),t),kt={},Ut=t=>{t._$AP?.(!1,!0);let e=t._$AA;const s=t._$AB.nextSibling;for(;e!==s;){const t=e.nextSibling;e.remove(),e=t}},Tt=(t,e,s)=>{const i=new Map;for(let r=e;r<=s;r++)i.set(t[r],r);return i},Ot=At(class extends wt{constructor(t){if(super(t),t.type!==$t)throw Error("repeat() can only be used in text expressions")}ht(t,e,s){let i;void 0===s?s=e:void 0!==e&&(i=e);const r=[],o=[];let n=0;for(const e of t)r[n]=i?i(e,n):n,o[n]=s(e,n),n++;return{values:o,keys:r}}render(t,e,s){return this.ht(t,e,s).values}update(t,[e,s,i]){const r=(t=>t._$AH)(t),{values:o,keys:n}=this.ht(e,s,i);if(!Array.isArray(r))return this.dt=n,o;const a=this.dt??=[],l=[];let c,h,d=0,p=r.length-1,u=0,m=o.length-1;for(;d<=p&&u<=m;)if(null===r[d])d++;else if(null===r[p])p--;else if(a[d]===n[u])l[u]=Et(r[d],o[u]),d++,u++;else if(a[p]===n[m])l[m]=Et(r[p],o[m]),p--,m--;else if(a[d]===n[m])l[m]=Et(r[d],o[m]),St(t,l[m+1],r[d]),d++,m--;else if(a[p]===n[u])l[u]=Et(r[p],o[u]),St(t,r[d],r[p]),p--,u++;else if(void 0===c&&(c=Tt(n,u,m),h=Tt(a,d,p)),c.has(a[d]))if(c.has(a[p])){const e=h.get(n[u]),s=void 0!==e?r[e]:null;if(null===s){const e=St(t,r[d]);Et(e,o[u]),l[u]=e}else l[u]=Et(s,o[u]),St(t,r[d],s),r[e]=null;u++}else Ut(r[p]),p--;else Ut(r[d]),d++;for(;u<=m;){const e=St(t,l[m+1]);Et(e,o[u]),l[u++]=e}for(;d<=p;){const t=r[d++];null!==t&&Ut(t)}return this.dt=n,((t,e=kt)=>{t._$AH=e})(t,l),F}}),Pt=Symbol("scroller-context");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Rt(t,e){return new Date(t+"T"+e).getTime()}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const It=At(class extends wt{constructor(t){if(super(t),t.type!==_t||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.it){this.it=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.st?.has(t)&&this.it.add(t);return this.render(e)}const s=t.element.classList;for(const t of this.it)t in e||(s.remove(t),this.it.delete(t));for(const t in e){const i=!!e[t];i===this.it.has(t)||this.st?.has(t)||(i?(s.add(t),this.it.add(t)):(s.remove(t),this.it.delete(t)))}return F}});
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Mt extends wt{constructor(t){if(super(t),this.et=W,t.type!==$t)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===W||null==t)return this.vt=void 0,this.et=t;if(t===F)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.vt;this.et=t;const e=[t];return e.raw=e,this.vt={_$litType$:this.constructor.resultType,strings:e,values:[]}}}Mt.directiveName="unsafeHTML",Mt.resultType=1;const Nt=At(Mt),Ht="important",zt=" !"+Ht,Lt=At(class extends wt{constructor(t){if(super(t),t.type!==_t||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,s)=>{const i=t[s];return null==i?e:e+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(t,[e]){const{style:s}=t.element;if(void 0===this.ut)return this.ut=new Set(Object.keys(e)),this.render(e);for(const t of this.ut)null==e[t]&&(this.ut.delete(t),t.includes("-")?s.removeProperty(t):s[t]=null);for(const t in e){const i=e[t];if(null!=i){this.ut.add(t);const e="string"==typeof i&&i.endsWith(zt);t.includes("-")||e?s.setProperty(t,e?i.slice(0,-11):i,e?Ht:""):s[t]=i}}return F}}),jt=["Autó","Belföld","Bulvár","Életmód","Gazdaság","Informatika","Külföld","Kultúra","Publicisztika","Sport"],Bt=jt.reduce(((t,e)=>(t[e]=e.toLowerCase().replace(/ /g,"-").normalize("NFD").replace(/[\u0300-\u036f]/g,""),t)),{});
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Dt(t){return{"--category-color":`var(--category-color-${Bt[t]??"unknown"})`}}function Vt(t){return Array.from(t.reduce(((t,e)=>(e.topic&&t.add(e.topic),t)),new Set)).sort(((t,e)=>t.localeCompare(e)))}class qt extends(function(t){return class extends t{static get properties(){return{...super.properties,imageLoaded:{type:Boolean,reflect:!0,attribute:"image-loaded"}}}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t);const e=this.shadowRoot.querySelector('img[data-loading="lazy"]');e?(e.addEventListener("load",this._lazyImageLoadComplete.bind(this)),e.addEventListener("error",(()=>{this._lazyImageLoadComplete.bind(this)}))):this._lazyImageLoadComplete()}_lazyImageLoadComplete(){this.imageLoaded=!0}renderSVGLoader(){return V`${this.imageLoaded?W:q`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs>
  ...
  <animate xlink:href="#e" attributeName="x" from="0%" to="200%" dur="1s" begin="0s" fill="freeze" repeatCount="indefinite"/>
    ...
    `}}window.customElements.define("lazy-image",qt);class Ft extends lt{render(){return V`
      <li
        class="newsitem ${It({active:this.isActive})}"
        style="${Lt(Dt(this.item.topic))}"
        role="article"
      >
        <header class="header">
          <h2 class="title">
            <a href="${this._permalink}" target="_blank">${Nt(this.item.title)}</a>
          </h2>
        </header>
        <div class="details">
          <div class="expander">
            <!-- TODO: Add a read more permalink -->
            <p class="lead">${Nt(this.item.lead)}</p>
    ...
    `]}window.customElements.define("news-item",Ft);window.customElements.define("news-items",class extends lt{render(){return V`
      <ol>
        ${Ot(this.items,(t=>t.id),((t,e)=>{const s=V`<news-item
              data-id="${t.id}"
    ...
    `}});class Wt extends lt{render(){return V`
      ${Ot(this.availableCategories,(t=>t),(t=>V`<a
            class="category-button ${It({selected:t===this.selectedCategory})}"
            style="${Lt(Dt(t))}"
  ...
  `}window.customElements.define("news-categories",Wt);const Gt={latestItemTimestamp:null};class Jt{static saveItemsToCache(t){localStorage.setItem("items",JSON.stringify(t))}static getItemsFromCache(){const t=localStorage.getItem("items");return t?JSON.parse(t):[]}static saveState(t){localStorage.setItem("state",JSON.stringify(t))}static getState(){const t=localStorage.getItem("state");return t?JSON.parse(t):Gt}}class Kt extends lt{render(){return V`
      <div class="header">
    ...
    `;var t,e}_itemsFromCache=Jt.getItemsFromCache();_previusUpdate=Jt.getState().latestItemTimestamp;constructor(){super(),this._items=this._itemsFromCache,this._availableCategories=jt,this._selectedCategory=null}connectedCallback(){super.connectedCallback(),this._dataTask.run()}_dataTask=new ut(this,{task:async(t,{signal:e})=>{const s=await(async t=>{const e=await fetch("https://stories-test-78664cfb8416.herokuapp.com/?randomize-media=true",{signal:t});if(200===e.status)return e.json().then((t=>(Jt.saveItemsToCache(t.slice(0,10)),t[0]&&Jt.saveState({...Jt.getState(),latestItemTimestamp:Rt(t[0].date,t[0].time)}),{items:t,categories:Vt(t)})));{const t=Jt.getItemsFromCache();if(t.length>0)return console.error(e.text()),{items:t,categories:jt};throw e.text()}})(e);return this._items=s.items,this._availableCategories=s.categories,s}});onCategorySelect(t){const e=t.detail.category;e!==this._selectedCategory?this._selectedCategory=e:this._selectedCategory=null}static properties={_items:{state:!0},_availableCategories:{state:!0},_selectedCategory:{state:!0}};static styles=[o`
    ...
    `]}window.customElements.define("scrollnews-app",Kt);export{Kt as App};
