 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{D:_t}=nt,vt=()=>document.createComment(""),bt=(t,e,s)=>{const i=t._$AA.parentNode,r=void 0===e?t._$AB:e._$AA;if(void 0===s){const e=i.insertBefore(vt(),r),o=i.insertBefore(vt(),r);s=new _t(e,o,t,t.options)}else{const e=s._$AB.nextSibling,o=s._$AM,n=o!==t;if(n){let e;s._$AQ?.(t),s._$AM=t,void 0!==s._$AP&&(e=t._$AU)!==o._$AU&&s._$AP(e)}if(e!==r||n){let t=s._$AA;for(;t!==e;){const e=t.nextSibling;i.insertBefore(t,r),t=e}}}return s},At=(t,e,s=t)=>(t._$AI(e,s),t),wt={},xt=t=>{t._$AP?.(!1,!0);let e=t._$AA;const s=t._$AB.nextSibling;for(;e!==s;){const t=e.nextSibling;e.remove(),e=t}},St=(t,e,s)=>{const i=new Map;for(let r=e;r<=s;r++)i.set(t[r],r);return i},Ct=yt(class extends $t{constructor(t){if(super(t),t.type!==ft)throw Error("repeat() can only be used in text expressions")}ht(t,e,s){let i;void 0===s?s=e:void 0!==e&&(i=e);const r=[],o=[];let n=0;for(const e of t)r[n]=i?i(e,n):n,o[n]=s(e,n),n++;return{values:o,keys:r}}render(t,e,s){return this.ht(t,e,s).values}update(t,[e,s,i]){const r=(t=>t._$AH)(t),{values:o,keys:n}=this.ht(e,s,i);if(!Array.isArray(r))return this.dt=n,o;const a=this.dt??=[],l=[];let h,c,d=0,p=r.length-1,u=0,m=o.length-1;for(;d<=p&&u<=m;)if(null===r[d])d++;else if(null===r[p])p--;else if(a[d]===n[u])l[u]=At(r[d],o[u]),d++,u++;else if(a[p]===n[m])l[m]=At(r[p],o[m]),p--,m--;else if(a[d]===n[m])l[m]=At(r[d],o[m]),bt(t,l[m+1],r[d]),d++,m--;else if(a[p]===n[u])l[u]=At(r[p],o[u]),bt(t,r[d],r[p]),p--,u++;else if(void 0===h&&(h=St(n,u,m),c=St(a,d,p)),h.has(a[d]))if(h.has(a[p])){const e=c.get(n[u]),s=void 0!==e?r[e]:null;if(null===s){const e=bt(t,r[d]);At(e,o[u]),l[u]=e}else l[u]=At(s,o[u]),bt(t,r[d],s),r[e]=null;u++}else xt(r[p]),p--;else xt(r[d]),d++;for(;u<=m;){const e=bt(t,l[m+1]);At(e,o[u]),l[u++]=e}for(;d<=p;){const t=r[d++];null!==t&&xt(t)}return this.dt=n,((t,e=wt)=>{t._$AH=e})(t,l),F}});
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Et(t,e){return new Date(t+"T"+e).getTime()}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kt=yt(class extends $t{constructor(t){if(super(t),t.type!==gt||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.it){this.it=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.st?.has(t)&&this.it.add(t);return this.render(e)}const s=t.element.classList;for(const t of this.it)t in e||(s.remove(t),this.it.delete(t));for(const t in e){const i=!!e[t];i===this.it.has(t)||this.st?.has(t)||(i?(s.add(t),this.it.add(t)):(s.remove(t),this.it.delete(t)))}return F}});
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ut extends $t{constructor(t){if(super(t),this.et=W,t.type!==ft)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===W||null==t)return this.vt=void 0,this.et=t;if(t===F)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.vt;this.et=t;const e=[t];return e.raw=e,this.vt={_$litType$:this.constructor.resultType,strings:e,values:[]}}}Ut.directiveName="unsafeHTML",Ut.resultType=1;const Tt=yt(Ut),Pt="important",Ot=" !"+Pt,Rt=yt(class extends $t{constructor(t){if(super(t),t.type!==gt||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,s)=>{const i=t[s];return null==i?e:e+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(t,[e]){const{style:s}=t.element;if(void 0===this.ut)return this.ut=new Set(Object.keys(e)),this.render(e);for(const t of this.ut)null==e[t]&&(this.ut.delete(t),t.includes("-")?s.removeProperty(t):s[t]=null);for(const t in e){const i=e[t];if(null!=i){this.ut.add(t);const e="string"==typeof i&&i.endsWith(Ot);t.includes("-")||e?s.setProperty(t,e?i.slice(0,-11):i,e?Pt:""):s[t]=i}}return F}}),Nt=["Autó","Belföld","Bulvár","Életmód","Gazdaság","Informatika","Külföld","Kultúra","Publicisztika","Sport"],Ht=Nt.reduce(((t,e)=>(t[e]=e.toLowerCase().replace(/ /g,"-").normalize("NFD").replace(/[\u0300-\u036f]/g,""),t)),{});
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function It(t){return{"--category-color":`var(--category-color-${Ht[t]??"unknown"})`}}function Mt(t){return Array.from(t.reduce(((t,e)=>(e.topic&&t.add(e.topic),t)),new Set)).sort(((t,e)=>t.localeCompare(e)))}class zt extends(function(t){return class extends t{static get properties(){return{...super.properties,imageLoaded:{type:Boolean,reflect:!0,attribute:"image-loaded"}}}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t);const e=this.shadowRoot.querySelector('img[data-loading="lazy"]');e?(e.addEventListener("load",this._lazyImageLoadComplete.bind(this)),e.addEventListener("error",(()=>{this._lazyImageLoadComplete.bind(this)}))):this._lazyImageLoadComplete()}_lazyImageLoadComplete(){this.imageLoaded=!0}renderSVGLoader(){return V`${this.imageLoaded?W:q`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs>
  ...
  <animate xlink:href="#e" attributeName="x" from="0%" to="200%" dur="1s" begin="0s" fill="freeze" repeatCount="indefinite"/>
    ...
    `}}window.customElements.define("lazy-image",zt);class Lt extends lt{render(){return V`
      <li
        class="newsitem ${kt({active:this.isActive})}"
        style="${Rt(It(this.item.topic))}"
        role="article"
      >
        <header class="header">
          <h2 class="title">
            <a href="${this._permalink}" target="_blank">${Tt(this.item.title)}</a>
          </h2>
        </header>
        <div class="details">
          <p class="lead">${Tt(this.item.lead)}</p>
    ...
    `}_permalink="";_sourceURL="";static properties={item:{type:Object},isActive:{type:Boolean,attribute:"is-active"}};willUpdate(t){const e=new URL(this.item.url);this._permalink=e.href}shouldUpdate(t){return!t.has("isActive")||this.isActive}firstUpdated(){const t=this.renderRoot.querySelector(".newsitem");this.renderRoot.querySelector(".details").animate([{maxHeight:0},{maxHeight:"500px"},{maxHeight:0}],{fill:"both",timeline:new window.ViewTimeline({axis:"block",subject:t}),rangeStart:"cover 20%",rangeEnd:"contain 100%"})}disconnectedCallback(){super.disconnectedCallback()}relativeTime({date:t,time:e}){return t&&e?function(t,e){const s="number"==typeof t?t:t.getTime(),i=Math.round((s-Date.now())/1e3),r=[60,3600,86400,604800,2592e3,31536e3,1/0],o=r.findIndex((t=>t>Math.abs(i))),n=o?r[o-1]:1;return new Intl.RelativeTimeFormat(e,{numeric:"auto"}).format(Math.floor(i/n),["second","minute","hour","day","week","month","year"][o])}(new Date(t+"T"+e),navigator.language):""}static styles=[o`
      .newsitem {
        --bubble-padding: 16px;
    ...
    `]}window.customElements.define("news-item",Lt);window.customElements.define("news-items",class extends lt{render(){return V`
      <ol>
    ...
    `}});class jt extends lt{render(){return V`
      ${Ct(this.availableCategories,(t=>t),(t=>V`<a
            class="category-button ${kt({selected:t===this.selectedCategory})}"
            style="${Rt(It(t))}"
  ...
  `}window.customElements.define("news-categories",jt);const Bt={latestItemTimestamp:null};class Dt{static saveItemsToCache(t){localStorage.setItem("items",JSON.stringify(t))}static getItemsFromCache(){const t=localStorage.getItem("items");return t?JSON.parse(t):[]}static saveState(t){localStorage.setItem("state",JSON.stringify(t))}static getState(){const t=localStorage.getItem("state");return t?JSON.parse(t):Bt}}class Vt extends lt{render(){return V`
      <div class="header">
      ...
      ${0===this._items.length&&this._dataTask.status===ct?V`<news-items-placeholder></news-items-placeholder>`:V`<news-items
    ...
    `;var t,e}_itemsFromCache=Dt.getItemsFromCache();_previusUpdate=Dt.getState().latestItemTimestamp;constructor(){super(),this._items=this._itemsFromCache,this._availableCategories=Nt,this._selectedCategory=null}connectedCallback(){super.connectedCallback(),this._dataTask.run()}_dataTask=new ut(this,{task:async(t,{signal:e})=>{const s=await(async t=>{const e=await fetch("https://stories-test-78664cfb8416.herokuapp.com/?randomize-media=true",{signal:t});if(200===e.status)return e.json().then((t=>(Dt.saveItemsToCache(t.slice(0,10)),t[0]&&Dt.saveState({...Dt.getState(),latestItemTimestamp:Et(t[0].date,t[0].time)}),{items:t,categories:Mt(t)})));{const t=Dt.getItemsFromCache();if(t.length>0)return console.error(e.text()),{items:t,categories:Nt};throw e.text()}})(e);return this._items=s.items,this._availableCategories=s.categories,s}});onCategorySelect(t){const e=t.detail.category;e!==this._selectedCategory?this._selectedCategory=e:this._selectedCategory=null}static properties={_items:{state:!0},_availableCategories:{state:!0},_selectedCategory:{state:!0}};static styles=[o`
    ...
    `]}window.customElements.define("scrollnews-app",Vt);export{Vt as App};
